...
namespace UnityEngine.XR.Interaction.Toolkit.Samples.StarterAssets
{
    ...
    public class ControllerInputActionManager : MonoBehaviour
    {
        ...
        [SerializeField]
        [Tooltip("Any Button we press lol.")]
        InputActionReference m_Button;
        ...
        void SetupInteractorEvents()
        {
            ...
            var buttonPressedAction = GetInputAction(m_Button);
            if (buttonPressedAction != null)
            {
                buttonPressedAction.started += OnStartButton;
                buttonPressedAction.canceled += OnStopButton;
            }
        }
        ...
        void OnStopButton(InputAction.CallbackContext context)
        {            
        }
        ...
        protected void Update()
        {
            ...
            if (Input.anyKeyDown)
            {
                Debug.Log("Input any key pressed: ");
            }
        }
